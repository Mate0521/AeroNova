...
<header class="text-center p-3 sticky-top mb-4">
    ...
    <?php }elseif($_SESSION["role"] == "U"){?>
        ...
        <nav class="navbar bg-body-tertiary fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="panelPiloto">AeroNova</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="?pid=<?php echo base64_encode('panelAdmin'); ?>"><i class="bi bi-box-arrow-in-down-left"></i>Dasboard</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="?pid=<?php echo base64_encode("indexRutas")?>" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="bi bi-sign-turn-slight-left"></i>
                                Rutas
                            </a>
                            <ul class="dropdown-menu text-center">
                                <li><a class="dropdown-item" href="?pid=<?php echo base64_encode("PanelDatos")?>">Crear Nueva Ruta</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li>
                                    <form action="?pid=<?php echo base64_encode("Home") ?>" method="POST">
                                        <button type="submit" class="btn btn-danger" name="cerrarSecion">Cerrar secion</button>
                                    </form>
                                </li>
                            </ul>
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="?pid=<?php echo base64_encode("Home")?>" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="bi bi-person-circle"></i>
                            <?php
                                echo $piloto->getNombre()." ".$piloto->getApellido();
                            ?>
                            </a>
                            <ul class="dropdown-menu text-center">
                                <li><a class="dropdown-item" href="?pid=<?php echo base64_encode("PanelDatos")?>">Datos Personales</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="?pid=<?php echo base64_encode('Home'); ?>">Home</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="d-flex">
                        <a href="?pid=<?= base64_encode("Login")?>" class="btn btn-outline-secondary">Iniciar Secion</a>
                    </div>
                </div>
            </div>
        </nav>
