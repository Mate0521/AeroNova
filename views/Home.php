                ...
                <div class="col-md-4">
                    <div class="card bg-dark text-light border border-white h-100">
                        ...
                        <div class="card-footer">
                            <form action="?pid=<?php echo base64_encode('reservarVuelo'); ?>&idV=<?php echo $vuelo->getIdVuelo(); ?>" method="POST">
                                <button type="submit" class="btn btn-primary w-100" name="reservarVuelo">
                                    Reservar
                                </button>
                            </form>
                        </div>
